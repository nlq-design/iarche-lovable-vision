...
import { useViviersDepartments } from '@/hooks/viviers/useViviersDepartments';
// Available sources
...
// DEPARTMENTS constant removed - now using dynamic useViviersDepartments hook
...
export function VivierFilters({
  ...
  const { data: departments = [] } = useViviersDepartments();
