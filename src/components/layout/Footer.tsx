            ...
            <ul className="space-y-2">
              ...
              <li>
                <NavLink to="/iarche-labs" className={`${linkClass} flex items-center gap-1.5`}>
                  <img src="/logos/iarche-labs.svg" alt="IArche Labs" className="h-5 w-auto opacity-70 hover:opacity-100 transition-opacity" style={{ imageRendering: 'optimizeQuality', filter: 'grayscale(1) brightness(2.5)' }} />
                </NavLink>
              </li>
              <li>
