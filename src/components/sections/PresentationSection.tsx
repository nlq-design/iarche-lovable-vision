    ...
    <section className="pt-8 pb-12 md:pt-12 md:pb-16">
      ...
      <div className="max-w-3xl mx-auto text-center space-y-4 invisible animate-fadeIn [animation-delay:0.2s]">
          <p className="text-lg md:text-xl text-primary leading-relaxed">
            <span className="hero-gradient-text font-bold">IArche</span> est une agence IA installée à Bayonne. On accompagne les dirigeants de PME dans l'intégration concrète de l'intelligence artificielle : audit, développement, accompagnement, conformité.
          </p>
