...
const AdminInvitationPreview = lazy(() => import("./pages/admin/AdminInvitationPreview"));
...
const CockpitDocumentDetail = lazy(() => import("./pages/cockpit/CockpitDocumentDetail"));
const CockpitDocumentSettings = lazy(() => import("./pages/cockpit/CockpitDocumentSettings"));
...
const CockpitSolution = lazy(() => import("./pages/CockpitSolution"));
...
const SettingsBranding = lazy(() => import("./pages/cockpit/settings/SettingsBranding"));
    ...
    <WorkspaceProvider>
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/cockpit-solution" element={<CockpitSolution />} />
