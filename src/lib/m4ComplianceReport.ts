...
type Status = 'CONFORME' | 'ÉCART' | 'BLOQUANT';
...
const COLORS = {
  blancCasse: [250, 249, 247] as [number, number, number],
  nightBlue: [26, 43, 74] as [number, number, number],
  terracotta: [176, 74, 50] as [number, number, number],
  textDark: [30, 30, 35] as [number, number, number],
  textMuted: [110, 110, 120] as [number, number, number],
  borderLight: [220, 218, 213] as [number, number, number],
  conformeBg: [220, 240, 225] as [number, number, number],
  conformeText: [30, 100, 60] as [number, number, number],
  ecartBg: [255, 240, 215] as [number, number, number],
  ecartText: [150, 90, 20] as [number, number, number],
  bloquantBg: [250, 220, 220] as [number, number, number],
  bloquantText: [160, 40, 40] as [number, number, number],
};
...
export const generateM4ComplianceReport = (): void => {
  ...
  const drawSection = (title: string, items: ComplianceItem[]) => {
    ensureSpace(14);
