...
const ANIMATIONS = [
  ...
  { name: 'constructionFade', duration: '6s', timing: 'ease-in-out infinite', usage: 'Rectangles décoratifs' },
  { name: 'lineDraw', duration: '6s', timing: 'ease-in-out', usage: 'Lignes SVG canalisation' },
];
