...
BEGIN
  ...
  IF NEW.entity_type NOT IN (
    ...
    RAISE EXCEPTION 'Invalid entity_type: %. Must be one of: lead, contact, opportunity, project, task, meeting_note, booking, specification, voice_transcription, uploaded_file, generated_document, article, partner', NEW.entity_type;
  END IF;
